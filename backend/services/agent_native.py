...
# Add edges
builder.add_edge("detect_summary", "summary", lambda x: x == "summary")
builder.add_edge("detect_summary", "condense", lambda x: x == "condense")
...
builder.add_edge("detect_casual", "respond_casual", lambda x: x == "casual")
builder.add_edge("detect_casual", "retrieve", lambda x: x == "retrieve")
